...
class QuestionCategorySeeder extends Seeder
{
    ...
    {
        $sqlFile = database_path('sql/question_categories.sql');
        ...
        preg_match_all('/INSERT INTO `question_categories`.*?;/is', $sql, $matches);
        ...
        $this->command->info('Question Categories seeded successfully!');
    }
}
