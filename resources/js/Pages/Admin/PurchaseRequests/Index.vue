<template>
    ...
    <div class="flex overflow-hidden flex-col gap-3 px-3 h-full">
        <div class="flex justify-between items-center h-10">
            ...
            >
                <PlusSquareIcon />
                <span class="hidden md:block">Buat Pengajuan</span>
            </Link>
        </div>
        ...
        >
            ...
            <div class="overflow-auto overflow-x-auto" data-simplebar>
                    ...
                    <thead>
                        <tr>
                            ...
                            >
                                <button
                                    ...
                                    class="px-3 w-full font-medium text-left text-gray-600 dark:text-gray-300 whitespace-nowrap"
                                >
                                    Pengajuan oleh
                                    <SortIcon
                        ...
                        <tr>
                            ...
                            >
                                <div class="relative space-x-4">
                                    <input
                                        ...
                                        class="rounded-lg border border-gray-200 bg-transparent py-2.5 pl-4 pr-14 text-sm text-gray-800 focus:border-blue-300 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20"
                                    />
                                    <span
                                        class="absolute right-10 top-1/2 -translate-y-1/2 text-gray-400"
                                        >🔍</span
                                    >
                                </div>
                            </th>
                            ...
                            <th
                                class="px-2 py-2 bg-gray-50 border border-gray-200 dark:border-gray-600 dark:bg-gray-900"
                            >
                                <Select v-model="filtersLocal.department_id" :items="[
                                    { id: null, name: 'Semua' },
                                    ...departments
                                ]" label="Pilih Departemen" class="w-full text-xs sm:text-sm" />
                            </th>
                            <th
                                class="px-2 py-2 bg-gray-50 border border-gray-200 dark:border-gray-600 dark:bg-gray-900"
                            >
                            ...
                            >
                                <select
                                    ...
                                    class="px-3 w-54 h-10 text-xs rounded border-gray-300 sm:text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white/90"
                                >
                            ...
                            >
                                ...
                                <template v-if="!isCollapsed(gkey)">
                                    ...
                                    >
                                        ...
                                        <td
                                            class="px-3 py-3 font-mono text-center whitespace-nowrap"
                                        >
                                            {{ row.request_no }}
                                        </td>
                                        <td
                            ...
                            >
                                ...
                                <td class="px-6 py-3">
                                    ...
                                    >
                                        ...
                                        <Link
                                            v-if="can_edit && row.status === 'on_progress'"
                                            :href="
                                                route(
                                                    'purchase-requests.edit',
                                                    row.id
                ...
                <Pagination :pagination="purchaseRequests" @page-change="changePage" @per-page-change="perPageChanged" class="border-t" />
            </div>

            <!-- Confirmation Modal -->
            <ConfirmModal
                :show="isConfirmModalOpen"
                :question="`Yakin ingin menghapus purchase request`"
...
const breadcrumbs = [{ label: "Penyimpanan" }, { label: "Pengajuan Barang" }];
...
function destroyData() {
    ...
    router.delete(route("purchase-requests.destroy", selectedItem.value.id), {
        preserveScroll: true,
        onSuccess: () => {
            closeConfirmModal();
            fetchRequests({});
