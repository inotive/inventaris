<template>
    ...
    <div v-if="isOpen" @click="goBack" class="fixed inset-0 z-[9999] bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div @click.stop class="bg-white rounded-lg shadow-xl w-full" :class="modalWidthClass"
                ...
                <div class="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Detail Pengajuan Cuti Sakit</h2>
                    <button @click="goBack"
                    ...
                    <div v-if="isStatusApprovedOrRejected" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="p-3 bg-gray-50 rounded border">
                                    <p class="text-gray-900 text-sm">
                                        {{ submission?.data?.leave_type || 'Cuti Sakit' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="submission?.data?.corrected_at" class="rounded-lg border border-amber-200 bg-amber-50 p-3">
                            <div class="flex items-start gap-2">
                                ...
                                <div class="text-xs text-amber-800">
                                    <p class="font-semibold">Telah dilakukan koreksi tanggal</p>
                                    <p class="mt-0.5">
                        ...
                        <!-- Tombol Koreksi Tanggal (hanya superadmin/HR, hanya status approved) -->
    ...
    <div v-if="showCorrectionForm" class="fixed inset-0 z-[10002] bg-black bg-opacity-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md" @click.stop>
            <div class="flex items-center justify-between p-4 border-b border-gray-200">
                <h3 class="text-base font-semibold text-gray-900">Koreksi Tanggal Pengajuan</h3>
...
console.log('DetailSick submission data:', props.submission);
console.log('Submission data structure:', {
    hasSubmission: !!props.submission,
    hasData: !!(props.submission?.data),
    hasId: !!(props.submission?.id),
    submissionKeys: props.submission ? Object.keys(props.submission) : [],
    dataKeys: props.submission?.data ? Object.keys(props.submission.data) : []
});
...
// Check if user has permission to approve sick submissions
const canApprove = computed(() => {
    return can('submission_sick.approve');
});
...
function handleConfirm() {
    ...
    router.put(route('submission.sick.update', props.submission?.data?.id), {
...
function submitCorrection() {
    ...
    router.patch(route('submission.sick.correct', props.submission?.data?.id), {
