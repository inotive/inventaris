    ...
    <div v-if="isOpen" @click="goBack" class="fixed inset-0 z-[9999] bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div @click.stop class="bg-white rounded-lg shadow-xl w-full" :class="modalWidthClass"
                ...
                <div class="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Detail Pengajuan Izin Lainnya</h2>
                    <button @click="goBack"
                ...
                <div v-if="submission" class="p-6">
                    ...
                    <div v-if="isStatusApprovedOrRejected" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Kategori Izin -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Kategori Izin</label>
                                <div class="p-3 bg-gray-50 rounded border">
                                    <p class="text-gray-900 text-sm">
                                        {{ submission?.data?.leave_type_name || 'Izin Lainnya' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-else class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="p-3 bg-gray-50 rounded border">
                                    <p class="text-gray-900 text-sm">
                                        {{ submission?.data?.leave_type_name || '-' }}
                                    </p>
                                </div>
                            </div>
                        </div>
...
// Check if user has permission to approve others submissions
const canApprove = computed(() => {
    return can('submission_others.approve');
});
...
function handleConfirm() {
    ...
    router.put(route('submission.others.update', props.submission?.data?.id), {
...
function submitCorrection() {
    ...
    router.patch(route('submission.others.correct', props.submission?.data?.id), {
