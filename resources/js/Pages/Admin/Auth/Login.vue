                            ...
                            <div class="overflow-hidden relative">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <!-- Title -->
                                        <h3
                                            class="px-4 text-3xl font-bold leading-tight"
                                        >
                                            {{ slide.title }}
                                        </h3>
                                        ...
                                        <!-- Description -->
                                        <p
                                            class="px-8 text-lg leading-relaxed text-white/90"
                                        >
                                            {{ slide.description }}
                                        </p>
                                    </div>
...
const slides = ref(
    props.workPrinciples.length > 0
        ? props.workPrinciples
        : [
              {
