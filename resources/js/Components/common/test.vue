        ...
        >
            ...
            >
                ...
                >
                    <div
                        v-if="showSlot"
                        class="bg-white rounded-lg shadow-xl transform transition-all sm:w-full sm:mx-auto px-8"
                        :class="maxWidthClass"
                    >
                        <!-- Header -->
                        ...
                        <div class="mt-6">
                            <button
                                @click="confirm"
                                class="bg-green-500 hover:bg-green-600 w-full flex items-center justify-center gap-2 rounded-lg p-4 text-white font-semibold transition"
                            >
                                <svg
                                    width="18"
                                    height="18"
                                ...
                                >
                                    <path
                                        d="M7.38508 17.3381C6.99844 17.271 6.62628 17.1377 6.28503 16.944L1.98333 14.4812C1.46288 14.1807 1.03046 13.7488 0.729359 13.2287C0.428253 12.7087 0.269015 12.1186 0.267578 11.5176V6.50994C0.270809 6.15291 0.328955 5.7985 0.439974 5.45915L6.91715 9.09589C7.06274 9.17687 7.18334 9.29622 7.26584 9.44096C7.34834 9.5857 7.38958 9.75028 7.38508 9.91682V17.3381ZM7.54927 8.04509C7.6853 8.12363 7.8396 8.16497 7.99668 8.16497C8.15375 8.16497 8.30806 8.12363 8.44409 8.04509L14.9295 4.33447C14.6729 4.0262 14.3645 3.76506 14.0182 3.56279L9.71653 1.09999C9.19543 0.797191 8.60347 0.637695 8.00078 0.637695C7.39809 0.637695 6.80613 0.797191 6.28503 1.09999L1.98333 3.56279C1.61533 3.77493 1.2897 4.05325 1.02284 4.38372L7.54927 8.04509ZM9.07621 9.09589C8.93214 9.17795 8.8132 9.29777 8.73219 9.44243C8.65118 9.58709 8.61118 9.75111 8.61648 9.91682V17.3627C9.00312 17.2957 9.37528 17.1624 9.71653 16.9686L14.0182 14.5058C14.5387 14.2054 14.9711 13.7735 15.2722 13.2534C15.5733 12.7333 15.7325 12.1432 15.734 11.5423V6.50994C15.7313 6.12938 15.6647 5.75197 15.537 5.39347L9.07621 9.09589Z"
                                        fill="white"
                                    />
                                </svg>
                                {{ confirmText }}
