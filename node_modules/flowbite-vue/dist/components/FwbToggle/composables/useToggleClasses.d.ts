...
export declare function useToggleClasses(props: UseToggleClassesProps): {
    ...
    toggleColor: import("vue").ComputedRef<string | undefined>;
    toggleBallClasses: import("vue").ComputedRef<string>;
    toggleBallOrder: import("vue").ComputedRef<string | undefined>;
    labelOrder: import("vue").ComputedRef<string | undefined>;
};
