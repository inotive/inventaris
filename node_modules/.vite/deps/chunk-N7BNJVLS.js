...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K(r), l2 = h(), d = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C2((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), p = "", f2 = "";
    i2.left + a2 + d > l2.width - O() ? i2.left < d ? e % 2 === 1 ? p = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (p = l2.width - d - O() + "px") : p = "-100%" : p = "100%", t2.getBoundingClientRect().top + u + s4 > l2.height ? f2 = `-${s4 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = p;
  }
}
function Kt(t2, e) {
  let o = getComputedStyle(t2).getPropertyValue("borderTopWidth"), n = o ? parseFloat(o) : 0, r = getComputedStyle(t2).getPropertyValue("paddingTop"), i2 = r ? parseFloat(r) : 0, l2 = t2.getBoundingClientRect(), s4 = e.getBoundingClientRect().top + document.body.scrollTop - (l2.top + document.body.scrollTop) - n - i2, a2 = t2.scrollTop, u = t2.clientHeight, p = C2(e);
  s4 < 0 ? t2.scrollTop = a2 + s4 : s4 + p > u && (t2.scrollTop = a2 + s4 - u + p);
}
function _t(t2, e = "", o) {
...
//# sourceMappingURL=chunk-N7BNJVLS.js.map
