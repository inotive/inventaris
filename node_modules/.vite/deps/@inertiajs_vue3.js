...
function assignValue(object, key2, value) {
  ...
  if (!(hasOwnProperty4.call(object, key2) && eq_default(objValue, value)) || value === void 0 && !(key2 in object)) {
...
function arrayLikeKeys(value, inherited) {
  ...
  for (var key2 in value) {
    if ((inherited || hasOwnProperty6.call(value, key2)) && !(skipIndexes && // Safari 9 has enumerable `arguments.length` in strict mode.
...
function baseKeys(object) {
  ...
  for (var key2 in Object(object)) {
    if (hasOwnProperty7.call(object, key2) && key2 != "constructor") {
      result2.push(key2);
    }
  }
  return result2;
...
var assign = createAssigner_default(function(object, source) {
  ...
  for (var key2 in source) {
    if (hasOwnProperty8.call(source, key2)) {
...
function hashGet(key2) {
  ...
  return hasOwnProperty10.call(data, key2) ? data[key2] : void 0;
}
...
function hashHas(key2) {
  var data = this.__data__;
  return nativeCreate_default ? data[key2] !== void 0 : hasOwnProperty11.call(data, key2);
}
...
var countBy = createAggregator_default(function(result2, value, key2) {
  if (hasOwnProperty16.call(result2, key2)) {
    ++result2[key2];
  } else {
...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto19[key2]) && !hasOwnProperty17.call(object, key2)) {
...
function baseHas(object, key2) {
  return object != null && hasOwnProperty19.call(object, key2);
}
...
function isEmpty(value) {
  ...
  for (var key2 in value) {
    if (hasOwnProperty21.call(value, key2)) {
      return false;
    }
  }
  return true;
...
function baseUnset(object, path) {
  ...
  while (++index < length) {
    ...
    if (key2 === "__proto__" && !hasOwnProperty22.call(object, "__proto__")) {
      return false;
    }
...
function baseRange(start2, end, step, fromRight) {
  var index = -1, length = nativeMax12(nativeCeil4((end - start2) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
...
function customDefaultsAssignIn(objValue, srcValue, key2, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto26[key2]) && !hasOwnProperty23.call(object, key2)) {
    return srcValue;
  }
  return objValue;
}
