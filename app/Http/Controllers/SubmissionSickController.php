...
class SubmissionSickController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Submission/Index', [
            ...
            'start_date' => $startDateFilter,
            'type_filter' => SubmissionTypeEnum::SICK->value,
    ...
    {
        try {
            $submission = app(GetSubmissionById::class)->execute($id, SubmissionTypeEnum::SICK->value);
            ...
            return Inertia::render('Admin/Submission/components/DetailSick', [
    ...
    public function update(Request $request, $id)
    {
        ...
        app(UpdateSubmissionSick::class)->execute($request->all(), $submission);
