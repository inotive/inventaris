...
class SubmissionProcurementController extends Controller
{
    public function index(Request $request){
        ...
        $typeFilter = SubmissionTypeEnum::PROCUREMENT->value;
        ...
        return Inertia::render('Admin/Submission/Index', [
            ...
            'type_filter' => SubmissionTypeEnum::PROCUREMENT->value,
            'status_filter' => $statusFilter,
            'branches' => $branches,
            'submission_types' => $submissionTypes,
            'submission_statuses' => $submissionStatuses,
            'statistics' => app(Statistics::class)->data(SubmissionTypeEnum::PROCUREMENT->value),
            'type' => "procurement",
